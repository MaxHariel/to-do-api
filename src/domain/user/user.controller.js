...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.singUp = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = user_entity_1.User.bind;
                        return [4 /*yield*/, this.userService.save(user)];
                    case 1: return [2 /*return*/, new (_a.apply(user_entity_1.User, [void 0, _b.sent()]))()];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        user = request.user;
                        _a = class_transformer_1.classToPlain;
    ...
    ], UserController.prototype, "singUp");
    __decorate([
        common_1.Put(),
        __param(0, common_1.Body())
